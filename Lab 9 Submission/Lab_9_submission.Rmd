...
mod1 = stan(data = stan_data, file = 'model1.stan', refresh = 0)
```
...
mod2 = stan(data = stan_data, file = 'model2.stan', refresh = 0)
```
## Model 3:
...
mod3 = stan(data = stan_data, file = 'model3.stan', refresh = 0)
```
...
the uncertainty level fro model 1 is less but it is more truncated towards points.
