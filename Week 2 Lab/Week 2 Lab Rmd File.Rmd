...
We plot the histograms again, with outliers removed. The distributions look similar, but the plot is better visually as the bins do not have to spread far apart. 
